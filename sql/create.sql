...
CREATE TABLE `modelrun` (
  ...
  `store` char(3) DEFAULT NULL,
  `code` varchar(100) DEFAULT NULL,
  `form` enum('tablet','other') DEFAULT 'other',
  `grossinga` double DEFAULT NULL,
  `paida` double DEFAULT NULL,
...
CREATE TABLE `sale` (
  ...
  `parentidentifier` varchar(1000) DEFAULT NULL,
