...
public class IosMacLinkAccountForm extends Composite implements LinkableAccountFields {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see io.reflection.app.client.part.linkaccount.LinkableAccountFields#validate()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see io.reflection.app.client.part.linkaccount.LinkableAccountFields#getAccountTypeName()
	 */
	@Override
