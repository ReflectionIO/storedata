...
public class LinkGoogleAccountRequest extends Request {
	...
	public LinkGoogleAccountRequest source(DataSource source) {
		this.source = source;
		return this;
	}

	public LinkGoogleAccountRequest username(String username) {
		this.username = username;
		return this;
	}

	public LinkGoogleAccountRequest password(String password) {
