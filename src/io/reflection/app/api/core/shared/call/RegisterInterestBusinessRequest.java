...
public class RegisterInterestBusinessRequest extends Request {
	public User user;
	...
	public RegisterInterestBusinessRequest user(User user) {
		this.user = user;
		return this;
	}

	public RegisterInterestBusinessRequest actionCode(String actionCode) {
