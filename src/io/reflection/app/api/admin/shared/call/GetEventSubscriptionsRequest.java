//  
//  GetEventSubscriptionsRequest.java
//  reflection.io
//
...
public class GetEventSubscriptionsRequest extends Request {
	public Pager pager;
	public String query;
	...
	public GetEventSubscriptionsRequest pager(Pager pager) {
		this.pager = pager;
		return this;
	}

	public GetEventSubscriptionsRequest query(String query) {
		this.query = query;
		return this;
	}
}