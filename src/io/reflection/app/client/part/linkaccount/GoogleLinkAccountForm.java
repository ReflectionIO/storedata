...
public class GoogleLinkAccountForm extends Composite implements LinkableAccountFields, HasLinkedAccountChangeEventHandlers {

	private static GoogleLinkAccountFormUiBinder uiBinder = GWT.create(GoogleLinkAccountFormUiBinder.class);

	interface GoogleLinkAccountFormUiBinder extends UiBinder<Widget, GoogleLinkAccountForm> {}
