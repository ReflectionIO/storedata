...
public class MiniAppCell extends AbstractCell<Item> {
	...
	public void render(Context context, Item value, SafeHtmlBuilder builder) {
		...
		final SafeUri link = PageType.ItemPageType.asHref(NavigationController.VIEW_ACTION_PARAMETER_VALUE, value.internalId, FilterController.DOWNLOADS_CHART_TYPE,
