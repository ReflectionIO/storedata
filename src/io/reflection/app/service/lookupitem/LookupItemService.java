...
public class LookupItemService {
	...
	public List<Item> getDataAccountItems(DataAccount dataAccount) throws DataAccessException {
		...
		String getLookupItemsForDataAccountQuery = String.format("select itemid, max(title) from lkp_items where dataaccountid=%s and parentsku is null group by itemid", dataAccountId);
