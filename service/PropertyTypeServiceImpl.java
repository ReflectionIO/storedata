...
public class PropertyTypeServiceImpl implements PropertyTypeService {
	...
	@Override
	public PropertyType findPropertyByName(String name) {
		Map param = new HashMap();
		param.put("name", name);
		return this.getPropertyTypeMapper().findPropertyByName(param);
	}

	@Override
	public List<PropertyType> searchPropertyByName(String name) {
		Map param = new HashMap();
		param.put("name", name);
		return this.getPropertyTypeMapper().searchPropertyByName(param);
	}
